...
class AppConfig(AppDefaultConfig):
    ...
    receive_topic = {
        'model_type': 'direct',
        'exchange_name': 'alg-server.local_receive_topic.exchange',
        'routing_key': 'alg-server.local_receive_topic.route',
        'queue': 'alg-server.local_receive_topic.queue',
    }

    send_topic = {
        'model_type': 'direct',
        'exchange_name': 'alg-server.local_send_topic.exchange',
        'routing_key': 'alg-server.local_send_topic.route',
        'queue': 'alg-server.local_send_topic.queue',
    }
