...
class AppConfig(AppDefaultConfig):
    ...
    RABBITMQ_V_HOST = os.getenv('RABBITMQ_V_HOST') or '/prod'
    ...
    receive_topic = {
        'model_type': 'direct',
        'exchange_name': 'alg-server.prod_receive_topic.exchange',
        'routing_key': 'alg-server.prod_receive_topic.route',
        'queue': 'alg-server.prod_receive_topic.queue',
    }

    send_topic = {
        'model_type': 'direct',
        'exchange_name': 'alg-server.prod_send_topic.exchange',
        'routing_key': 'alg-server.prod_send_topic.route',
        'queue': 'alg-server.prod_send_topic.queue',
    }
